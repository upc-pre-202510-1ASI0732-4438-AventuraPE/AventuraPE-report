...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>28/04/2025</td>
      <td>AventuraPE</td>
      <td>Sprint 1 - Implementación inicial del frontend web y móvil. Se desarrollaron las funcionalidades básicas de registro, login, landing page y navegación principal. Se estableció la arquitectura base del sistema y la configuración inicial del entorno de desarrollo. Implementación de las primeras user stories del product backlog.</td>
    </tr>
    <tr>
      <td>1.1</td>
      <td>12/05/2025</td>
      <td>AventuraPE</td>
      <td>Sprint 2 - Desarrollo del backend RESTful API con Spring Boot. Implementación de las entidades principales, controladores y servicios para gestión de usuarios, actividades y comentarios. Configuración de la base de datos relacional y establecimiento de endpoints principales para el CRUD de funcionalidades core.</td>
    </tr>
    <tr>
      <td>1.2</td>
      <td>26/05/2025</td>
      <td>AventuraPE</td>
      <td>Sprint 3 - Integración frontend-backend y funcionalidades de búsqueda. Implementación del sistema de filtros avanzados, geolocalización, y funcionalidad "Sorpréndeme". Desarrollo de la sección administrativa para gestión de contenido y moderación. Primeras pruebas de integración entre aplicación web y móvil.</td>
    </tr>
    <tr>
      <td>1.3</td>
      <td>09/06/2025</td>
      <td>AventuraPE</td>
      <td>Sprint 4 - Implementación de funcionalidades sociales y sistema de calificaciones. Desarrollo del sistema de comentarios, rating de actividades, perfiles de usuario mejorados y sistema de favoritos. Optimización de la experiencia de usuario en dispositivos móviles y mejoras en la interfaz web.</td>
    </tr>
    <tr>
      <td>2.0</td>
      <td>23/06/2025</td>
      <td>AventuraPE</td>
      <td>Sprint 5 - Implementación de pipelines CI/CD y testing automatizado. Configuración de GitHub Actions, implementación de pruebas unitarias, integración y sistema con JUnit y Jest. Establecimiento de prácticas DevOps, deployment automatizado y monitoreo continuo. Auditorías de experiencia de usuario realizadas.</td>
    </tr>
    <tr>
      <td>2.1</td>
      <td>01/07/2025</td>
      <td>AventuraPE</td>
      <td>Sprint 6 - Experimentos de optimización de rendimiento. Implementación de Redis Cache para optimización de comentarios, soft delete para operaciones administrativas, y optimización de consultas de base de datos. Implementación de modo oscuro/claro y sistema de internacionalización (i18n) español-inglés.</td>
    </tr>
    <tr>
      <td>0.3</td>
      <td>08/07/2025</td>
      <td>AventuraPE</td>
      <td>Actualización integral del Capítulo VIII (Experiment-Driven Development) con la integración completa del experimento Barbara Nexus (chatbot IA). Se añadió Barbara Nexus a todas las secciones relevantes: Raw Material, Scale Calculations and Decisions, Sprint Backlogs (TA031-TA036), validation interviews, experiment aftermath & analysis, y continuous learning. Se incluyeron métricas de rendimiento, entrevistas de validación específicas, análisis de resultados con satisfacción del usuario de 9.2/10 y tiempo de respuesta de 45 segundos. La integración asegura que Barbara Nexus sea tratado como experimento de primera clase junto con Redis, modo oscuro, i18n y otras funcionalidades implementadas.</td>
    </tr>
  </tbody>
</table>
...
|----|----|----|
|4.c.1 Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software.| **Cama Salvatierra, Jimena Tamara**<br>*TB1*: Reconoció su responsabilidad ética y profesional al diseñar experiencias de usuario tanto móviles como web, asegurando una interfaz accesible, intuitiva y centrada en el usuario final. Su compromiso se evidenció en el desarrollo funcional de la página web y la aplicación móvil, respetando buenas prácticas de diseño y programación.<br>*TP*: Demostró profesionalismo al gestionar los Sprint Backlogs y coordinar la implementación de la Landing Page, velando por la coherencia visual y la experiencia del usuario final, priorizando siempre sus necesidades y expectativas.<br>*TB2*: Asumió responsabilidad ética al liderar el diseño e implementación de pruebas de usuario y auditorías de usabilidad, asegurando que la interfaz cumpliera con estándares de accesibilidad y experiencia del usuario. Su trabajo en la planificación y ejecución de experimentos de UX/UI demostró un compromiso profesional con la mejora continua basada en evidencia.<br>*TF*: Consolidó su responsabilidad profesional al coordinar la integración final de todas las funcionalidades de interfaz, garantizando coherencia visual y experiencia de usuario óptima en todas las plataformas. Su liderazgo en la validación final del producto demostró un enfoque ético centrado en satisfacer las necesidades del usuario final.<br>**Castillo Castillo, Jair Alexander**<br>*TB1*: Demostró responsabilidad ética y profesional al implementar la arquitectura del backend y al liderar el despliegue de la solución, priorizando la seguridad, la eficiencia y la escalabilidad. Además, su trabajo en el desarrollo de la web y app móvil se llevó a cabo respetando estándares técnicos y buenas prácticas del software.<br>*TP*: Asumió con ética profesional el desarrollo del To-Be Scenario Mapping, Impact Mapping y las diferentes pruebas de software (unitarias, integración, BDD y sistema), garantizando que el producto final cumpliera con los estándares de calidad y seguridad necesarios para los usuarios.<br>*TB2*: Lideró la implementación de prácticas DevOps y pipelines de CI/CD, asegurando la integridad y seguridad del código en todos los ambientes de desarrollo. Su enfoque profesional en la automatización de pruebas y despliegue continuo demostró compromiso con la calidad y confiabilidad del software.<br>*TF*: Culminó su responsabilidad profesional al supervisar la entrega final del producto, asegurando que todos los componentes técnicos cumplieran con los más altos estándares de calidad, seguridad y rendimiento. Su liderazgo técnico garantizó una solución robusta y escalable para los usuarios finales.<br>**Gutierrez Garcia, Jose Eduardo**<br>*TB1*: Asumió su responsabilidad profesional en la redacción de la introducción, descripción de la startup y el desarrollo web, garantizando que la documentación reflejara claramente la visión, objetivos y valores éticos del proyecto. Su trabajo permitió establecer una base sólida para las decisiones de ingeniería tomadas posteriormente.<br>*TP*: Demostró alto nivel de responsabilidad ética al configurar entornos de desarrollo y despliegue seguros, implementando prácticas de gestión de código y guías de estilo que aseguraron la mantenibilidad y seguridad del software, además de configurar correctamente el sistema de despliegue continuo.<br>*TB2*: Asumió responsabilidad ética en la configuración de herramientas de análisis estático de código y métricas de calidad, estableciendo estándares profesionales para el mantenimiento y evolución del software. Su trabajo en la documentación técnica y guías de contribución demostró compromiso con la transparencia y accesibilidad del proyecto.<br>*TF*: Consolidó su responsabilidad profesional al finalizar la documentación técnica completa del proyecto, asegurando que todos los aspectos del desarrollo estuvieran claramente documentados para futuras mejoras y mantenimiento. Su enfoque ético garantizó la transferencia de conocimiento y sostenibilidad del proyecto.<br>**Jaque Peña, Estefano Oscar**<br>*TB1*: Actuó con responsabilidad ética al analizar a los competidores y realizar el needfinding, asegurando que la solución respondiera a necesidades reales de los usuarios. En el desarrollo web, se mantuvo alineado con buenas prácticas técnicas y con una visión orientada al usuario.<br>*TP*: Tomó responsabilidad profesional en la implementación de prácticas de integración continua y entrega continua, garantizando flujos de trabajo seguros y confiables que protegieran tanto los datos como la experiencia de los usuarios finales.<br>*TB2*: Realizó parte de las entrevistas para cada segmento objetivo además de apoyar en los experiments cards, así como las hipótesis. Su enfoque profesional en la recolección y análisis de datos de usuario demostró compromiso con la toma de decisiones basada en evidencia.<br>*TF*: Finalizó su contribución profesional al consolidar todos los hallazgos de investigación de usuario y experimentos, asegurando que las decisiones finales del producto estuvieran respaldadas por datos concretos y necesidades reales de los usuarios. Su trabajo garantizó la alineación entre la solución técnica y las expectativas del mercado.<br>**Quezada Portalatino, Barbara Susana**<br>*TB1*: Evidenció responsabilidad ética y profesional en la definición de user stories y el product backlog, priorizando funcionalidades con base en valor para el usuario y viabilidad técnica. Además, su rol en el diseño UX/UI y en el desarrollo de la app móvil se alineó con principios de diseño centrado en el usuario.<br>*TP*: Mantuvo su compromiso ético al refinar y desarrollar las User Stories y el Product Backlog, asegurando que las funcionalidades implementadas respondieran a necesidades reales y satisficieran los requerimientos de los usuarios finales de manera responsable y transparente.<br>*TB2*: Lideró la planificación y ejecución de experimentos de producto, incluyendo el diseño de Barbara Nexus (chatbot IA), demostrando responsabilidad profesional en la innovación tecnológica centrada en el usuario. Su enfoque ético en la priorización de funcionalidades aseguró que cada experimento contribuyera al valor del producto final.<br>*TF*: Culminó su responsabilidad profesional al supervisar la entrega final del product backlog y la validación completa de todas las user stories implementadas. Su liderazgo en la gestión de producto aseguró que la solución final cumpliera con todos los requisitos de calidad y satisfacción del usuario establecidos desde el inicio del proyecto.| TB1, TP, TB2 & TF:<br> El equipo ha mantenido un compromiso constante con la responsabilidad ética y profesional a lo largo de todo el ciclo de desarrollo del proyecto. Desde la concepción inicial hasta la entrega final, cada miembro ha aplicado buenas prácticas en sus respectivas áreas de responsabilidad, demostrando evolución y madurez profesional. La toma de decisiones ha sido guiada por principios éticos como la accesibilidad, seguridad, transparencia y respeto por las necesidades del usuario final. Las implementaciones técnicas han seguido estándares profesionales rigurosos, incorporando prácticas avanzadas de DevOps, testing automatizado y experimentación basada en datos. En TB2 y TF, se consolidó el compromiso ético con la implementación de experimentos como Barbara Nexus, demostrando responsabilidad en la innovación tecnológica. Este enfoque integral y responsable ha permitido entregar una solución que no solo es funcional sino también confiable, segura y éticamente sólida, cumpliendo con todos los estándares profesionales de la ingeniería de software moderna.|


| Criterio específico | Acciones realizadas | Conclusiones |
|----|----|----|
|4.c.2 Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales| **Cama Salvatierra, Jimena Tamara**<br>*TB1*: Emitió juicios informados al considerar cómo el diseño UX/UI de la plataforma impactaría a nivel social, promoviendo una interacción amigable y accesible. Su enfoque de diseño tuvo en cuenta la diversidad de usuarios, contribuyendo a una solución inclusiva en un contexto digital cada vez más relevante globalmente.<br>*TP*: Realizó evaluaciones fundamentadas sobre el impacto de los Sprint Backlogs y la Landing Page implementada, considerando cómo estas decisiones afectaban la percepción inicial de la plataforma y su capacidad para atraer usuarios de diversos contextos socioeconómicos.<br>*TB2*: Emitió juicios informados sobre el impacto de las pruebas de usabilidad y experimentos de UX en la experiencia global del usuario, considerando aspectos culturales, económicos y sociales de diferentes segmentos de usuarios. Su análisis contribuyó a decisiones de diseño más inclusivas y accesibles.<br>*TF*: Consolidó juicios informados sobre el impacto final del producto en contextos globales, evaluando cómo las decisiones de diseño contribuían a una experiencia de usuario sostenible y socialmente responsable en diversos mercados y culturas.<br>**Castillo Castillo, Jair Alexander**<br>*TB1*: Emitió juicios informados al utilizar impact mapping para evaluar escenarios futuros, considerando cómo las decisiones técnicas afectarían al entorno social y económico del proyecto. Su enfoque integral permitió al equipo alinear los objetivos técnicos con el impacto real en la comunidad objetivo.<br>*TP*: Profundizó sus juicios informados al desarrollar el escenario To-Be y el Impact Mapping definitivos, alineando las capacidades técnicas con las necesidades sociales y económicas de los usuarios. Sus decisiones sobre estrategias de testing aseguraron que el producto funcionara correctamente en diversos entornos y contextos.<br>*TB2*: Evaluó el impacto de las prácticas DevOps y CI/CD en la sostenibilidad económica y ambiental del proyecto, considerando la eficiencia de recursos, costos operativos y escalabilidad global. Sus decisiones técnicas reflejaron un análisis profundo del impacto social de la tecnología implementada.<br>*TF*: Emitió juicios finales informados sobre el impacto global de la arquitectura técnica implementada, evaluando su contribución al desarrollo sostenible, eficiencia económica y accesibilidad social en diferentes contextos geográficos y culturales.<br>**Gutierrez Garcia, Jose Eduardo**<br>*TB1*: Emitió juicios informados al plasmar el enfoque Lean UX dentro del documento, mostrando cómo las decisiones centradas en el usuario impactan positivamente en el ámbito social y económico. Su contribución ayudó a guiar el desarrollo con una mirada estratégica y empática.<br>*TP*: Formuló valoraciones cuidadosas sobre la configuración de entornos de desarrollo y despliegue, considerando factores como accesibilidad global, eficiencia económica y sostenibilidad ambiental de las soluciones implementadas. Su trabajo en continuous deployment reflejó un análisis sobre el impacto social de las actualizaciones frecuentes en la experiencia del usuario.<br>*TB2*: Evaluó el impacto de las herramientas de análisis estático y métricas de calidad en la sostenibilidad económica y técnica del proyecto, considerando los beneficios globales de mantener altos estándares de código. Su trabajo contribuyó a decisiones informadas sobre la eficiencia y escalabilidad del sistema.<br>*TF*: Culminó con juicios informados sobre el impacto final de la documentación técnica y las prácticas de desarrollo en la sostenibilidad global del proyecto, evaluando cómo estas decisiones facilitarían el mantenimiento, la evolución y la transferencia de conocimiento en contextos internacionales.<br>**Jaque Peña, Estefano Oscar**<br>*TB1*: Emitió juicios informados al identificar oportunidades de diferenciación basadas en el análisis del mercado y las necesidades detectadas, lo cual permitió diseñar una solución con impacto social positivo. Su enfoque estratégico buscó maximizar la utilidad y sostenibilidad del producto.<br>*TP*: Realizó evaluaciones críticas sobre las herramientas y prácticas de integración y entrega continua, valorando su impacto económico en términos de eficiencia operativa y su impacto social al facilitar actualizaciones rápidas que responden a las necesidades cambiantes de los usuarios.<br>*TB2*: Realizó parte de las entrevistas para cada segmento objetivo además de apoyar en los experiments cards, así como las hipótesis. Su análisis de datos de usuario consideró el impacto social, económico y cultural de las decisiones de producto en diferentes contextos globales.<br>*TF*: Finalizó con juicios informados sobre el impacto global de la investigación de usuario y los experimentos realizados, evaluando cómo los hallazgos contribuían a una solución más inclusiva, sostenible y socialmente responsable en diferentes mercados y culturas.<br>**Quezada Portalatino, Barbara Susana**<br>*TB1*: Emitió juicios informados al estructurar las funcionalidades considerando el contexto social del proyecto y su accesibilidad, contribuyendo a una solución inclusiva y orientada a mejorar la experiencia del usuario. Su visión de diseño equilibró impacto social y eficiencia técnica.<br>*TP*: Desarrolló juicios críticos en la elaboración final de User Stories y Product Backlog, evaluando cuidadosamente cómo cada característica podría impactar en diferentes segmentos sociales de usuarios y en sus distintas realidades económicas, priorizando funcionalidades con mayor valor e impacto positivo.<br>*TB2*: Emitió juicios informados sobre el impacto de los experimentos de producto, incluyendo Barbara Nexus, en contextos sociales, económicos y ambientales. Su análisis consideró cómo la innovación tecnológica podría contribuir a soluciones más sostenibles y socialmente responsables.<br>*TF*: Culminó con juicios informados sobre el impacto global del product backlog final y las user stories implementadas, evaluando cómo el producto completo contribuía al desarrollo sostenible, la inclusión social y la eficiencia económica en diferentes contextos globales.| TB1, TP, TB2 & TF:<br> A lo largo del desarrollo completo del proyecto, el equipo ha demostrado una notable capacidad para emitir juicios informados sobre el impacto de las soluciones implementadas en contextos globales, económicos, ambientales y sociales. Las decisiones técnicas han considerado consistentemente aspectos que van más allá de la funcionalidad pura, evaluando su repercusión en diferentes contextos culturales, económicos y sociales. Se ha tenido especial cuidado en diseñar una experiencia inclusiva y accesible, valorando la diversidad de usuarios y sus diferentes realidades socioeconómicas. Las prácticas de integración continua, testing automatizado, DevOps y experimentación han sido seleccionadas considerando su eficiencia económica, sostenibilidad ambiental y impacto social. En TB2 y TF, se profundizó el análisis del impacto global mediante experimentos como Barbara Nexus, evaluando cómo la innovación tecnológica puede contribuir a soluciones más inclusivas y sostenibles. Este enfoque integral ha permitido crear una solución técnicamente sólida que también tiene un impacto positivo y responsable en la sociedad, demostrando que el equipo comprende plenamente la responsabilidad global de la ingeniería de software en el contexto actual.|
...
![alt text](images/evidence/image.png)
![alt text](images/evidence/22b55075-4458-4d16-bde7-dd9058184340.jpg)
